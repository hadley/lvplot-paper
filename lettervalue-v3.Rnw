...
with(ot, LVboxplot(sqrt(TaxiOut+TaxiIn)~UniqueCarrier,
                   ...
                   ylab="Square Root of Taxi Time (in minutes)",
                   median.col="grey50"))
legend( x = 15.5, y= 13.5, legend=1:14, fill=c("grey50", rev(cols)[-1]),
...
par(mar=c(3,4,0,5))
with(ot, LVboxplot(sqrt(CarrierDelay)~UniqueCarrier, col=cols, horizontal=FALSE,  xlab="Carrier", ylab="Square Root of Carrier Delay (in minutes)", median.col="grey50"))
legend( x = 15.25, y= 35, legend=1:11, fill=c("grey50", rev(cols)[-(1:4)]),
              title="LV", xpd=TRUE, x.intersp=0.25)
...
par(mar=c(3,4,0,5))
with(ot, LVboxplot(sqrt(NASDelay)~UniqueCarrier, col=cols, horizontal=FALSE,  xlab="Carrier", ylab="Square Root of NAS Delay (in minutes)", median.col="grey50"))

legend( x = 15.25, y= 23, legend=1:12, fill=c("grey50", rev(cols)[-(1:3)]),
              title="LV", xpd=TRUE, x.intersp=0.25)
@
...
par(mar=c(3,4,0,5))
with(ot, LVboxplot(sqrt(WeatherDelay)~UniqueCarrier, col=cols, horizontal=FALSE,  xlab="Carrier", ylab="Square Root of Weather Delay (in minutes)", median.col="grey50"))
legend( x = 15.25, y= 24.5, legend=1:11, fill=c("grey50", rev(cols)[-(1:4)]),
              title="LV", xpd=TRUE, x.intersp=0.25)
