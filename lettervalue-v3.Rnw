...
\begin{figure}[hbtp]
  \centering
<<fig-taxi-2, dependon='taxi-data', echo=FALSE, fig.width=10, fig.height=5.5, out.width='\\textwidth', message=FALSE>>=
par(mar=c(3,4,1,5))
...
\centering
<<sim-xpl-lv-2, dependson='simu-data', echo=FALSE, fig.width=10, fig.height=5.5, out.width='0.8\\linewidth', warning=FALSE>>=
par(mar=c(4,2,0,5))
>>>>>>> discussion of widths
