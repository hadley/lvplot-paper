...
Using location depths, introduced by \citet{tukey75}, letter values could be extended to two dimensions, which would allow to include letter-values in  bagplots \citep{bagplots, aplpack}.
